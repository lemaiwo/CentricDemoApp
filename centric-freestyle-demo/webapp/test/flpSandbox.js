		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "centric-freestyle-demo",
									"targetURL": "#bewlcentricfreestyledemo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"bewlcentricfreestyledemo-display": {
								"semanticObject": "bewlcentricfreestyledemo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=be.wl.centricfreestyledemo",
									"url": sap.ui.require.toUrl("be/wl/centricfreestyledemo")
								}
							}
						}
					}
