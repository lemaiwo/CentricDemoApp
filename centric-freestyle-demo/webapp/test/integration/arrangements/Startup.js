sap.ui.define([
	"sap/ui/test/Opa5",
	"be/wl/centricfreestyledemo/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("be.wl.centricfreestyledemo.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "be.wl.centricfreestyledemo",
					async: true
				},
				hash: oOptions.hash,
